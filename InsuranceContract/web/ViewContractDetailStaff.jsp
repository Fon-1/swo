...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h3 style="text-align: center;">Chi tiết hợp đồng</h3>
                    ...
                    <div class="col-sm-4" style="width: 30%; padding: 0;">
                        <div class="policy-detail-content" style="margin-bottom: 16px;">
                            ...
                            <div class="services" style="padding-bottom: 10px;">
                                <div class="service-name"><a href="#">Yêu cầu thay đổi thông tin hợp đồng</a></div>
                                <div class="service-name"><a href="#">Yêu cầu bồi thường</a></div>
                            </div>
                        </div>
                    </div>
                </div>
