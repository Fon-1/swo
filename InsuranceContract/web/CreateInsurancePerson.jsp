<%-- 
    Document   : createInsurancePerson
    Created on : Jan 17, 2024, 10:15:50 PM
    Author     : maian
--%>
...
<html>
    <head>
        ...
        <title>Tạo Người Được Bảo Hiểm</title>
    ...
    <body>
        ...
        <section id="page-content" style="margin-top: 0px;">
            <div class="container">
                ...
                <h2 style="text-align: center;">Bước 1: Thông tin Người Được Bảo Hiểm</h2>
                <div class="container-body">
                    <h3>Thông tin cá nhân</h3>
                    <form action="createinsuperson" method="get">
                        <div class="info-detail">
                            ...
                            <input class="content" type="text" id="fullName" name="fullName" placeholder="Họ và tên" 
                                   value="${sessionScope.insuPerson.fullName}" required 
                        ...
                        <div class="info-detail">
                            ...
                            <select class="content" name="gender">
                                <option value="1" ${sessionScope.insuPerson.gender eq '1' ? "selected":""}>Nam</option>
                                <option value="0" ${sessionScope.insuPerson.gender eq '0' ? "selected":""}>Nữ</option>
                            </select>
                        </div>
                        ...
                        <div class="info-detail">
                            ...
                            <input class="content" type="text" id="nationality" name="nationality" placeholder="Quốc tịch"
                                   value="${sessionScope.insuPerson.nationality}" required 
                        ...
                        <div class="info-detail">
                            ...
                            <input class="content" type="text" id="job" name="job" 
                                   placeholder="Nghề nghiệp" value="${sessionScope.insuPerson.job}"/>
                        </div>

                        <div class="info-detail">
                            <div class="label">Địa chỉ<span style="color: red;">*</span></div>
                            <input class="content" type="text" id="address" name="address" placeholder="Địa chỉ"
                                   value="${sessionScope.insuPerson.address}" required 
                        ...
                        <div class="info-detail">
                            ...
                            <input class="content" type="text" id="phoneNumber" name="phoneNumber" placeholder="Số điện thoại"
                                   value="${sessionScope.insuPerson.phoneNumber}"/>
                        ...
                        <div class="info-detail">
                            ...
                            <input class="content" type="email" id="email" name="email" 
                                   placeholder="Email" value="${sessionScope.insuPerson.email}"/>
                        </div>
