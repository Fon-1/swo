 ...
 * @author maian
 */
@WebServlet(name="ContractChangeInfoServlet", urlPatterns={"/contractChangeInfo"})
public class ContractChangeInfoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ContractChangeInfoServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ContractChangeInfoServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("ContractChangeInfo.jsp").forward(request, response);
    } 
