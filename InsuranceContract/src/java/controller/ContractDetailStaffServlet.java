 ...
 * @author DUong
 */
@WebServlet(name = "ContractDetailStaffServlet", urlPatterns = {"/contractDetailStaff"})
public class ContractDetailStaffServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ViewContractDetailStaff.jsp").forward(request, response);
    }
