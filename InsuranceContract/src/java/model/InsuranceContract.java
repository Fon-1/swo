...
public class InsuranceContract {
    ...
    public InsuranceContract(String contractID, String customerID, int packageID, int insuranID, int beneID, String staffID, String Status, long sumAssured, String effectiveDate, String maturityDate, String expiryDate, int insuranceTime, String premiumMode, String contract_pdf) {
